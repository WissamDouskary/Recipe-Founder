    ...
    <section class="py-20 bg-gray-50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <RecipsCards v-for="meal in state.meals.slice(0, 3)" :meal="meal" :key="meal.idMeal" class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl flex flex-col transition-shadow duration-300">
          </RecipsCards>
